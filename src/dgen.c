...
void *rofotreetypeptrs[] = {DL_tree1_tiles,DL_tree2_tiles,DL_tree3_tiles,DL_tree4_tiles};
...
void gen_TestDungeon(uint8_t roomdensity, uint8_t floorid)  {
	...
	vptr = rofotreetypeptrs[rofotreetypemap[floorid-1]];
